//package app.com.vladimirjeune.gotjokes;
//
...
import app.com.vladimirjeune.jokewizard.JokeWizard;
...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView second_tv = (TextView) rootView.findViewById(R.id.tv_jokes_2);

        JokeSmith myJoker = new JokeSmith();
        JokeWizard jokeWizard = new JokeWizard();

        textView.setText(myJoker.getJoke());
        second_tv.setText(jokeWizard.getJoke());
